...
independence number at most four. We give an elementary fixed-point argument
excluding 15 prime-order automorphism cycle types. A dated public-source
audit found 11 of those small-support types previously uncovered. We then
exclude the next order-3 type, $3^6 1^{25}$, using four orbit-CNF branches
whose compressed binary DRAT proofs are retained and independently checked.
The combined original result closes 12 cycle types that the audited public
records listed as uncovered or unfinished. The result does not determine
...
\section{The cycle type $3^6 1^{25}$}
...
2026 found the following 11 types uncovered before
...
The combined original result therefore excludes 12 previously uncovered or
...
Vigleik Angeltveit and Brendan D. McKay.
\newblock $R(5,5)\le46$.
\newblock \url{https://arxiv.org/abs/2409.15709}, version 2, 2025.

\bibitem{Wustep2026}
Wustep.
\newblock Ramsey $R(5,5)$ research record.
\newblock \url{https://github.com/wustep/maths/tree/main/problems/ramsey-r55},
audited commit \texttt{4b7b8275d41682a98add180ee05540be84037100}, 2026.

\bibitem{Kriebel2026}
Alec Kriebel.
\newblock Prescribed-automorphism cycle-type coverage audit.
\newblock \url{https://github.com/AlecKriebel/Math/tree/main/ramsey55},
audited commit \texttt{137ffa9f1a340f621651395ad0236cf1bdadb51c}, 2026.
